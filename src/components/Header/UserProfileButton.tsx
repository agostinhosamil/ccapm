...
import { useAppointments } from "client@hooks/useAppointments";
import { Appointment } from "client@types/Appointment";
import { UpdateAppointmentModal } from "./UpdateAppointmentModal";

export const UserProfileButton = () => {
  const [showUserProfileDialog, setShowUserProfileDialog] = useState(false);
  const [updatingAppointment, setUpdatingAppointment] = useState<
    boolean | Appointment
  >(false);
  ...
  const useProfileButtonClickHandler = async (event: React.MouseEvent) => {
  ...
  const editAppointmentHandler = async (appointment: Appointment) => {
    const result = await resolvePromise(async () => {
  ...
  return (
    <Fragment>
      ...
      <UpdateAppointmentModal
        ...
        appointment={
          typeof updatingAppointment === "object" ? updatingAppointment : null
        }
