...
type CreateStyledHTMLElementProps = {
  elementStyles: StyleProps
  props: CreateStylesProps
}

function createStyledHTMLElement(elementTagName: string, { elementStyles, props }: CreateStyledHTMLElementProps) {
...
export function createStyledElement(elementTagName: string, elementStyles: StyleProps) {
  return function (props: CreateStylesProps) {
    return createStyledHTMLElement(elementTagName, { elementStyles, props })
  }
}
...
// type StyledFunctionComponent = ((elementTagName: string, elementStyles: StyleProps) => (props: CreateStylesProps) => HTMLElement)
//   | ((elementStyles: StyleProps) => (props: CreateStylesProps) => HTMLElement)

// type StyledScopeProps = {
//   createStyledElement: StyledFunctionComponent
//   [key: string]: StyledFunctionComponent
// }

// App.scope('styled', ['utils'], function (this: StyledScopeProps, utils) {

//   this.createStyledElement = function createStyledElement(elementTagName, elementStyles) {
//     return function (props) {
//       return createStyledHTMLElement(elementTagName, { elementStyles, props })
//     }
//   }

//   const htmlElementsNames = utils.getHTMLElementsNames()

//   if (htmlElementsNames instanceof Array) {
//     for (const htmlElementsName of htmlElementsNames) {
//       this[htmlElementsName] = function (elementStyles: StyleProps) {
//         return function (props: CreateStylesProps) {
//           return createStyledHTMLElement(htmlElementsName, { elementStyles, props })
//         }
//       }
//     }
//   }
